...
| # | Document | What it covers | Read it when you need to... |
|---|---|---|---|
| 1 | [README.md](./README.md) | Technical architecture: stack, sitemap, project structure, dev phases, install/deploy steps | Set up the project, understand the tech stack, deploy to Vercel |
| 2 | [CONTENT.md](./CONTENT.md) | Every approved word of website copy, page by page (Home, Menu, About, Gallery, Contact, Footer, microcopy, SEO titles/descriptions) | Write or check any text that appears on the site |
| 3 | [DESIGN-SYSTEM.md](./DESIGN-SYSTEM.md) | Colors, typography, spacing, components, motion, photography direction, accessibility targets | Build or review any UI component, pick a color/font/spacing value |
...
**If you're starting the build:**
`README.md` → `DESIGN-SYSTEM.md` → `CONTENT.md` → `MASTER-PROMPT.md` → `SKILL-ORCHESTRATION.md`

**If you're collecting information from the client:**
`CLIENT-DATA-CHECKLIST.md` → `ASSET-CHECKLIST.md`

**If you're getting ready to launch:**
`LEGAL-PAGES.md` → `SEO-GUIDE.md` (Launch Checklist section) → `LAUNCH-CHECKLIST.md`
...
| **Backend** | None in V1 — static product data + localStorage cart + WhatsApp ordering |
| **Social** | [Instagram](https://www.instagram.com/tinytreatsbyswetha) · [Facebook](https://www.facebook.com/profile.php?id=61592823341135) · [X](https://x.com/tinytreatsbys) · [LinkedIn](https://www.linkedin.com/in/tinay-treats-by-swetha-a09202383/) |

...
export const HERO_SLIDES: HeroSlide[] = [
  {
    id: "01",
    eyebrow: "SIGNATURE HOMEMADE TREATS",
    headlineMain: "Wholesome Homemade Treats,",
    headlineAccent: "Baked with Love.",
    description:
      "Crunchy, nutty almond cookies, freshly baked in small batches with carefully selected unrefined ingredients.",
  ...
  },
  {
    ...
    headlineMain: "Crispy Seed Crunch,",
    headlineAccent: "Made Pure & Better.",
    description:
  ...
  },
  {
    ...
    headlineMain: "Artisan Millet Goodness,",

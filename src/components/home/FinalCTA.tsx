...
export function FinalCTA() {
  return (
    <section className="relative overflow-hidden bg-[#FFF8ED] py-20 sm:py-28 select-none">
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        ...
        <div className="relative rounded-3xl sm:rounded-[2.5rem] bg-gradient-to-br from-[#FFFFFF] via-[#FFFDF9] to-[#FAF2E4] border-2 border-[#D99A45]/30 p-8 sm:p-12 lg:p-16 shadow-[0_20px_60px_rgba(90,50,27,0.08)] overflow-hidden">
          ...
          <div className="flex items-center justify-center gap-2 mb-6">
            <BotanicalSprig className="w-5 h-5 text-[#D99A45] -scale-x-100" />
            ...
            <BotanicalSprig className="w-5 h-5 text-[#D99A45]" />
          </div>

          <div className="relative z-10 max-w-3xl mx-auto text-center space-y-6">
            {/* Headline */}
            <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-[#3A1E0E] leading-tight">
              Ready for a{" "}
            ...
            {/* Description */}
            <p className="text-base sm:text-lg text-[#5A321B]/85 max-w-2xl mx-auto font-normal leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2 max-w-2xl mx-auto">
              <div className="flex items-center justify-center gap-2.5 px-4 py-3 rounded-2xl bg-[#FFF8ED] border border-[#5A321B]/10 text-xs font-semibold text-[#5A321B] shadow-2xs">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              ...
              <a
                ...
                className="group relative flex items-center justify-center gap-3 w-full sm:w-auto h-13 px-8 rounded-2xl bg-[#66723A] hover:bg-[#566331] text-white font-semibold text-sm shadow-[0_8px_25px_rgba(102,114,58,0.25)] hover:shadow-[0_12px_35px_rgba(102,114,58,0.38)] hover:scale-[1.02] active:scale-[0.98] transition-all border border-emerald-400/20"
              >
            ...
            {/* Divider & Signature */}
            <div className="pt-6 border-t border-[#5A321B]/10 max-w-md mx-auto space-y-2">
              <BotanicalDivider className="text-[#D99A45]/60 scale-90" />
              <div className="flex items-center justify-center gap-2 font-script text-2xl text-[#D99A45]">
